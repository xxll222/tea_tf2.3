...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('茶叶病虫害识别系统')
        # 模型初始化
        self.model = tf.keras.models.load_model("models/mobilenet_tea.h5")
        self.to_predict_name = "images/tt.jpg"
        self.class_names = ['Anthracnose', 'algal leaf', 'bird eye spot', 'brown blight', 'gray light', 'healthy', 'red leaf spot', 'white spot']
        self.resize(900, 700)
        self.initUI()
    ...
    def initUI(self):
        ...
        about_title = QLabel('欢迎使用茶叶病虫害识别系统')
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/bj.jpg'))
        about_img.setAlignment(Qt.AlignCenter)
        label_super = QLabel("作者：liuwenhui")
